...
@implementation DWQVideoBottomBar

- (UIButton *)playPauseBtn {
    
    if (!_playPauseBtn) {
        _playPauseBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        [_playPauseBtn setImage:[UIImage imageNamed:DWQVideoPlayerImageName(@"pause")] forState:UIControlStateNormal];
...
- (UIButton *)changeScreenBtn {
    ...
    if (!_changeScreenBtn) {
        ...
        [_changeScreenBtn setImage:[UIImage imageNamed:DWQVideoPlayerImageName(@"full_screen")] forState:UIControlStateNormal];
...
- (UISlider *)videoProgressSlider {
    ...
    if (!_videoProgressSlider) {
        ...
        [_videoProgressSlider setThumbImage:[UIImage imageNamed:DWQVideoPlayerImageName(@"dot")] forState:UIControlStateNormal];
...
+ (instancetype)videoBottomBar {
    ...
    return [[DWQVideoBottomBar alloc] init];
}
